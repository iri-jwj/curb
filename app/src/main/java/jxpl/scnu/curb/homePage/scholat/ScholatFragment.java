...
public class ScholatFragment extends Fragment implements ScholatContract.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        m_scholatAdapter = new ScholatAdapter(checkNotNull(getContext()), m_ScholatRecycler);
    ...
    public void showScholats(List<ScholatHomework> para_homeworkList) {
        ...
        lc_baseData.addAll(para_homeworkList);
        m_scholatAdapter.replaceData(lc_baseData);
    }
